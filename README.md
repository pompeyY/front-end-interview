...
<p align="center">
  ...
  <a href="#公众号"><img src="https://img.shields.io/badge/%E5%85%AC%E4%BC%97%E5%8F%B7-程序员**官-lightgrey.svg" alt="公众号"></a>
  <a href="#公众号"><img src="https://img.shields.io/badge/PDF-前端**手册-important.svg" alt="公众号"></a>
</p>
...
* [**官到底想看什么样的简历？](docs/guide/resume.md)
* [**回答问题的技巧](docs/guide/project.md)
...
* [浏览器**题](docs/guide/browser.md)
* [DOM**题](docs/guide/dom.md)
...
* [HTTP**题](docs/guide/http.md)
* [TCP**题](docs/guide/tcp.md)

### 数据结构与算法

* [算法**题](docs/guide/algorithm.md)

### 前端框架

* [关于前端框架的**须知](docs/guide/framework.md)
* [Vue**题](docs/guide/vue.md)
* [React**题](docs/guide/react.md)
...
* [webpack**题](docs/guide/webpack.md)
...
* [前端安全**题](docs/guide/security.md)

## 说明

### 关于读者

本项目一开始并没有要做一个仅仅面向**的项目,而是希望借助**的形式进一步巩固、完善自身的知识，同时为初学者提供一个参考路径。

* 对于前端新人: 本项目的**题都是相对高频的题目,且有一定的难度,非常适合作为学习教程,相对复杂的**题我们都有更详细的原理详解,总之,这是可以当做前端学习手册的项目.
* 对于**候选人: 本项目梳理了主流的**题,并且有意去掉了一些相对简单的**题,对于有一定难度的**题也有更详细的详解部分,这是查漏补缺同时完善知识体系的「良药」,而如果你只想快速应对**,我们也提供了纯**化的《前端**手册》关注[公众号](#公众号)即可获取。

### 关于内容

本项目的主要内容来源由三部分组成:

* 作者手打: 主要搜集了近几年的主流**题,并针对每个**题进行回答
* 作者之前的博客: 部分比较长篇的原理详解来源于作者之前的博客内容
* 转载: 一些**题在网上已经有非常好的对应文章,没有必要进行二次创作,因此作者按照转载规范进行了转载,如有侵权立即删除
...
**题部分作者分为了七大模块,虽然大体完成了,但是依然有几个重要的模块需要打磨:

* 数据结构与算法: 这部分仅仅列举了一些非常常见的查找、排序算法，还没有更深入的讲解,也缺少数据结构部分的内容
* TypeScript: 这部分我另开了一个项目,已经脱离**的范畴了,更像是一本深入浅出的手册,但是只完成了一半
